...
/**
 * Experimental inline script adding.
 */
function print_my_inline_script() {
  $filename = (ENVIRONMENT == 'development' ? 'adams.js' : 'adams.min.js');
  $script = file_get_contents(get_template_directory() . '/assets/js/' . $filename);
?>
